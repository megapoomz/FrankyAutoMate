...
class UpdateProgressWindow(ctk.CTkToplevel):
    def __init__(self, parent, new_version, download_url):
        ...
        self.lbl_title = ctk.CTkLabel(self, text=f"📥 กำลังโหลดเวอร์ชัน v{new_version}", font=("Tahoma", 18, "bold"), text_color="white")
        self.lbl_title.pack(pady=(30, 5))
        
        ctk.CTkLabel(self, text="กรุณารอสักครู่ ระบบกำลังเตรียมการติดตั้ง...", font=("Tahoma", 12), text_color="#94a3b8").pack(pady=(0, 20))
        ...
        self.btn_cancel = ctk.CTkButton(self, text="ยกเลิกการโหลด", fg_color="#334155", font=("Tahoma", 11, "bold"), height=35, command=self.on_cancel)
