...
class VisionMixin:
    ...
    def setup_vision_tab(self):
        ...
        ctk.CTkLabel(t, text="ค้นหาด้วยข้อความ (OCR SEARCH)", font=("Inter", 10, "bold"), text_color="#64748b").pack(pady=(10, 3), anchor="w", padx=22)
        ...
        self.btn_ocr_region = ctk.CTkButton(f_reg, text="ตีกรอบพื้นที่ (แนะนำ)", command=self.start_pick_region, 
                                            fg_color="#334155", height=32, font=("Inter", 11))
        ...
        ctk.CTkButton(t, text="เพิ่มขั้นตอน OCR (ADD VISION ACTION)", command=self.add_ocr_action, 
                       fg_color="#2563eb", hover_color="#1d4ed8", height=40, font=("Inter", 13, "bold")).pack(pady=5, padx=20, fill="x")
